...
class NewsfeedController extends GetxController {
  ...
  void fetchPosts() async {
    try {
      isLoading(true);
      var response = await http.get(Uri.parse('http://192.168.56.1:8083/api/v1/post/community-feed')); // Use your local IP address instead of localhost
      ...
      Future<void> addComment(int postId, String content) async {
        final url = 'http://192.168.56.1:8083/api/v1/comment'; // Adjust the endpoint URL
